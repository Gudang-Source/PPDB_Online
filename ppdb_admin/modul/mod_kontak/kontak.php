...
$res = mysql_query ("SELECT * FROM ppdb_kontak WHERE aktif=1 ORDER BY ktk_id ASC LIMIT $posisi,$batas");  // menampilkan table ppdb kontak yang aktif urut
$jmldata = mysql_num_rows(mysql_query("SELECT * FROM ppdb_kontak WHERE aktif=1"));
