<?
 ...
 $res = mysql_query ("SELECT * FROM ppdb_admin ORDER BY admin_id DESC LIMIT $posisi,$batas");  // menampilkan tabel ppdb_admin
 $jmldata = mysql_num_rows(mysql_query("SELECT * FROM ppdb_admin"));  
?>
