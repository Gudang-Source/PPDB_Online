...
$id		= @$_GET['id'];
$act 	= @$_GET['act'];
$sql = mysql_query("SELECT*FROM ppdb_admin WHERE admin_id = '$id'")or die(mysql_error());  // menampilkan tabel ppdb admin berdasar id
