...
<div class="container">
	...
	$page		= new Paging9;
	 ...
	 $jmldata = mysql_num_rows(mysql_query("SELECT*FROM ppdb_adm_siswa WHERE nama LIKE '%$_GET[nama]%'"));  // cari untuk nama peserta
	 $jmlhalaman = $page->jumlahHalaman($jmldata,$batas);
	 $linkhalaman = $page->navHalaman($_GET['halaman'],$jmlhalaman);
	}
	?>
	...
	<div class="col-lg-12" align="center">
		<div class='btn-group'>
            <div class="btn-group"><a class="btn btn-default disabled"><?php CPendaftar('ppdb_adm_siswa');?>&nbsp;Pendaftar</a></div>
            <div class="btn-group"><a class="btn btn-default disabled"><?php SVerifikasi('ppdb_adm_siswa');?>&nbsp; Sudah Verifikasi</a></div>
            <div class="btn-group"><a class="btn btn-default disabled"><?php BVerifikasi('ppdb_adm_siswa');?>&nbsp; Belum Verifikasi</a></div>
   		</div>
		<div><br></div>
		<? echo "$linkhalaman";?>
    </div>
