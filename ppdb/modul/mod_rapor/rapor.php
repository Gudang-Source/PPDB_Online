...
<body>
	...
	<?
  // menampilkan tabel nilai 5 mapel berdasar nisn
	 $sql = mysql_query("SELECT  
        a.sem_1 as bhs1, a.sem_2 as bhs2, a.sem_3 as bhs3, a.sem_4 as bhs4, a.sem_5 as bhs5, a.rata_rata as bhs,
		...
		<form class="navbar-form navbar-center" action="" method="post" id="rapor">
			<table class="table table-bordered table-hover">
  			...
  			<tr>
				...
				<td align="center"><input name="bhs4" type="text" id="bhs4" value="<?= $row['bhs5']?>" size="3" maxlength="3"/></td>
