...
$biaya			= $_POST['biaya'];
	...
	$input = mysql_query("UPDATE ppdb_biodata SET 
						...
						tgung_biaya='$biaya', 
						sts_bio=1 WHERE nisn='$_SESSION[nisn]'");  // mengedit tabel ppbd_biodata
						
	$input1 = mysql_query("UPDATE ppdb_adm_siswa SET 
						nama='$nm_siswa',
						asal_skl='$asal_sklh'
						WHERE nisn='$_SESSION[nisn]'");  // mengedit nama dan asal sekolah di tabel ppdb_adm_siswa dg kunci nisn
	if($input && $input1){
		echo "sukses";
	}
	else{
