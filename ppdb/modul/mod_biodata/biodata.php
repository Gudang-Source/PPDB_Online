...
$sql = mysql_query("SELECT 
					...
					FROM
						  ppdb_biodata
					WHERE
						  nisn = '$_SESSION[nisn]'")or die(mysql_error());  // menampilkan table ppdb_biodata
...
<form action="#" method="post" id="biodata">
	<table width="75%" border="0" align="center">
	  <tr>
		<td colspan="6" bgcolor="#33CC33"><b>A. DATA PRIBADI SISWA</b></td>
	  </tr>
	  <tr>
		<td colspan="6">&nbsp;</td>
	  </tr>
	  ...
	  <tr>
		<td colspan="6" bgcolor="#33CC33"><H><b>B. KETERANGAN TEMPAT TINGGAL SISWA</b></H></td>
	  </tr>
	  <tr>
		<td colspan="6">&nbsp;</td>
	  </tr>
	  ...
	  <tr>
		<td colspan="6" bgcolor="#33CC33"><H><b>C. KETERANGAN JASMANI</b></H></td>
	  </tr>
	  <tr>
		<td colspan="6">&nbsp;</td>
	  </tr>
	  ...
	  <tr>
		<td colspan="6" bgcolor="#33CC33"><H><b>D. KETERANGAN PENDIDIKAN SEBELUMNYA</b></H></td>
	  </tr>
	  <tr>
		<td colspan="6">&nbsp;</td>
	  </tr>
	  ...
	  <tr>
		<td colspan="6" bgcolor="#33CC33"><H><b>E. KETERANGAN TENTANG ORANG TUA</b></H></td>
	  </tr>
	  <tr>
		<td colspan="6">&nbsp;</td>
	  </tr>
