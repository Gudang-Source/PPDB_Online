...
$inisial = date('Ym');
$date = date('Y-m-d');
if($_POST['captcha']==$_SESSION['captcha_session']){  // koreksi p.nahar
	...
	$input = mysql_query("insert into ppdb_adm_siswa(no_peserta, 
											 ...
											 values ('$auto',
													 ...
													 '$pass',
													 '$date'
													 ,0)");  // menyisipkan data ke tabel ppdb_adm_siswa
	
	$biodata = mysql_query("insert into ppdb_biodata(nisn,nm_siswa,asl_sekolah,sts_bio) values ('$nisn','$nama','$asal_skl',0)"); // menyisipkan data ke tabel ppdb_biodata

	// menyisipkan data ke tabel ppdb_masing_makul 
